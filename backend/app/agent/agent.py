...
try:
    ...
    if not os.getenv("OPENAI_API_KEY"):
        print("[WARNING] OPENAI_API_KEY not set. AI features will use fallback content.")
        ChatOpenAI = None
...
def node_enhance_prompt(state: 'CourseState') -> 'CourseState':
    ...
    if ChatOpenAI and ChatPromptTemplate:
        try:
            ...
            chain = prompt | ChatOpenAI(model="llama3-groq-3b-8192", temperature=0.2)
